...
public final class EventDis {
  ...
  public static final class CommEventLog extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.hikvision.cms.api.eps.beds.door.EventDis.internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.hikvision.cms.api.eps.beds.door.EventDis.internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_fieldAccessorTable;
    }
    ...
    public java.lang.String getLogId() { return logId_; }
    ...
    private java.lang.String unitIdx_ = "";
    public boolean hasUnitIdx() { return hasUnitIdx; }
    public java.lang.String getUnitIdx() { return unitIdx_; }
    ...
    private java.lang.String eventTypeName_ = "";
    public boolean hasEventTypeName() { return hasEventTypeName; }
    public java.lang.String getEventTypeName() { return eventTypeName_; }
    ...
    // repeated .com.hikvision.cms.api.eps.beds.door.TriggerResult rslt_msg = 33;
    public static final int RSLT_MSG_FIELD_NUMBER = 33;
    private java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult> rsltMsg_ =
      java.util.Collections.emptyList();
    public java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult> getRsltMsgList() {
      return rsltMsg_;
    }
    public int getRsltMsgCount() { return rsltMsg_.size(); }
    public com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult getRsltMsg(int index) {
      return rsltMsg_.get(index);
    }
    
    // repeated .com.hikvision.cms.api.eps.beds.door.CommEventTrig trig_info = 34;
    public static final int TRIG_INFO_FIELD_NUMBER = 34;
    private java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig> trigInfo_ =
      java.util.Collections.emptyList();
    public java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig> getTrigInfoList() {
      return trigInfo_;
    }
    public int getTrigInfoCount() { return trigInfo_.size(); }
    public com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig getTrigInfo(int index) {
    ...
    public final boolean isInitialized() {
      ...
      for (com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult element : getRsltMsgList()) {
        if (!element.isInitialized()) return false;
      }
      for (com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig element : getTrigInfoList()) {
        if (!element.isInitialized()) return false;
      }
      return true;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig element : getTrigInfoList()) {
        output.writeMessage(34, element);
      }
    ...
    public int getSerializedSize() {
      ...
      for (com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult element : getRsltMsgList()) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(33, element);
      }
      for (com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig element : getTrigInfoList()) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(34, element);
      }
    ...
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseFrom(
    ...
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseFrom(
    ...
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog prototype) {
    ...
    public static final class Builder extends
      ...
      private com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog result;
      
      // Construct using com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.newBuilder()
      private Builder() {}
      
      private static Builder create() {
        Builder builder = new Builder();
        builder.result = new com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog();
        return builder;
      }
      
      protected com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.getDescriptor();
      }
      
      public com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog getDefaultInstanceForType() {
        return com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog build() {
      ...
      private com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
        ...
        if (result.rsltMsg_ != java.util.Collections.EMPTY_LIST) {
          result.rsltMsg_ =
            java.util.Collections.unmodifiableList(result.rsltMsg_);
        }
        if (result.trigInfo_ != java.util.Collections.EMPTY_LIST) {
          result.trigInfo_ =
            java.util.Collections.unmodifiableList(result.trigInfo_);
        }
        com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog) {
          return mergeFrom((com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog)other);
        } else {
      ...
      public Builder mergeFrom(com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog other) {
        if (other == com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.getDefaultInstance()) return this;
        if (other.hasLogId()) {
        ...
        if (!other.rsltMsg_.isEmpty()) {
          if (result.rsltMsg_.isEmpty()) {
            result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult>();
          }
          result.rsltMsg_.addAll(other.rsltMsg_);
        }
        if (!other.trigInfo_.isEmpty()) {
          if (result.trigInfo_.isEmpty()) {
            result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig>();
          }
          result.trigInfo_.addAll(other.trigInfo_);
        }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 266: {
              com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult.Builder subBuilder = com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addRsltMsg(subBuilder.buildPartial());
              break;
            }
            case 274: {
              com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig.Builder subBuilder = com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addTrigInfo(subBuilder.buildPartial());
              break;
            }
          }
        }
  ...
  result.hasExtInfo = true;
      ...
      // repeated .com.hikvision.cms.api.eps.beds.door.TriggerResult rslt_msg = 33;
      public java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult> getRsltMsgList() {
        return java.util.Collections.unmodifiableList(result.rsltMsg_);
      }
      public int getRsltMsgCount() {
        return result.getRsltMsgCount();
      }
      public com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult getRsltMsg(int index) {
        return result.getRsltMsg(index);
      }
      public Builder setRsltMsg(int index, com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult value) {
        if (value == null) {
          throw new NullPointerException();
        }
        result.rsltMsg_.set(index, value);
        return this;
      }
      public Builder setRsltMsg(int index, com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult.Builder builderForValue) {
        result.rsltMsg_.set(index, builderForValue.build());
        return this;
      }
      public Builder addRsltMsg(com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.rsltMsg_.isEmpty()) {
        ...
        result.rsltMsg_.add(value);
        return this;
      }
      public Builder addRsltMsg(com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult.Builder builderForValue) {
        if (result.rsltMsg_.isEmpty()) {
          result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult>();
        }
        result.rsltMsg_.add(builderForValue.build());
        return this;
      }
      public Builder addAllRsltMsg(
          java.lang.Iterable<? extends com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult> values) {
        if (result.rsltMsg_.isEmpty()) {
          result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.TriggerResult>();
        }
        super.addAll(values, result.rsltMsg_);
        return this;
      }
      public Builder clearRsltMsg() {
        result.rsltMsg_ = java.util.Collections.emptyList();
        return this;
      }
      
      // repeated .com.hikvision.cms.api.eps.beds.door.CommEventTrig trig_info = 34;
      public java.util.List<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig> getTrigInfoList() {
        return java.util.Collections.unmodifiableList(result.trigInfo_);
      }
      public int getTrigInfoCount() {
        return result.getTrigInfoCount();
      }
      public com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig getTrigInfo(int index) {
        return result.getTrigInfo(index);
      }
      public Builder setTrigInfo(int index, com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig value) {
        if (value == null) {
          throw new NullPointerException();
        }
        result.trigInfo_.set(index, value);
        return this;
      }
      public Builder setTrigInfo(int index, com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig.Builder builderForValue) {
        result.trigInfo_.set(index, builderForValue.build());
        return this;
      }
      public Builder addTrigInfo(com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.trigInfo_.isEmpty()) {
        ...
        result.trigInfo_.add(value);
        return this;
      }
      public Builder addTrigInfo(com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig.Builder builderForValue) {
        if (result.trigInfo_.isEmpty()) {
          result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig>();
        }
        result.trigInfo_.add(builderForValue.build());
        return this;
      }
      public Builder addAllTrigInfo(
          java.lang.Iterable<? extends com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig> values) {
        if (result.trigInfo_.isEmpty()) {
          result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.door.Comm.CommEventTrig>();
        }
        super.addAll(values, result.trigInfo_);
        return this;
      }
      public Builder clearTrigInfo() {
        result.trigInfo_ = java.util.Collections.emptyList();
        return this;
      }
      
      // @@protoc_insertion_point(builder_scope:com.hikvision.cms.api.eps.beds.door.CommEventLog)
    }
    
    static {
      defaultInstance = new CommEventLog(true);
      com.hikvision.cms.api.eps.beds.door.EventDis.internalForceInit();
      defaultInstance.initFields();
    }
    
    // @@protoc_insertion_point(class_scope:com.hikvision.cms.api.eps.beds.door.CommEventLog)
  }
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_descriptor,
              new java.lang.String[] { "LogId", "EventState", "EventLevel", "UnitIdx", "EventType", "EventTypeName", "SubSysType", "EventName", "StartTime", "StopTime", "SourceIdx", "SourceType", "SourceName", "LogTxt", "RegionIdx", "ExtInfo", "UserId", "RsltMsg", "TrigInfo", },
              com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.class,
              com.hikvision.cms.api.eps.beds.door.EventDis.CommEventLog.Builder.class);
          return null;
        }
      };
