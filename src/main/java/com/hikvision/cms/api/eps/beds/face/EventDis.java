...
public final class EventDis {
  ...
  public static final class CommEventLog extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.hikvision.cms.api.eps.beds.face.EventDis.internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_descriptor;
    }
    
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.hikvision.cms.api.eps.beds.face.EventDis.internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_fieldAccessorTable;
    }
    ...
    private java.util.List<com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult> rsltMsg_ =
      java.util.Collections.emptyList();
    public java.util.List<com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult> getRsltMsgList() {
      return rsltMsg_;
    }
    public int getRsltMsgCount() { return rsltMsg_.size(); }
    public com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult getRsltMsg(int index) {
    ...
    private java.util.List<com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig> trigInfo_ =
      java.util.Collections.emptyList();
    public java.util.List<com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig> getTrigInfoList() {
      return trigInfo_;
    }
    public int getTrigInfoCount() { return trigInfo_.size(); }
    public com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig getTrigInfo(int index) {
    ...
    public final boolean isInitialized() {
      ...
      for (com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult element : getRsltMsgList()) {
        if (!element.isInitialized()) return false;
      }
      for (com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig element : getTrigInfoList()) {
        if (!element.isInitialized()) return false;
      }
      return true;
    }
    ...
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseFrom(
    ...
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseFrom(
    ...
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog prototype) {
    ...
    public static final class Builder extends
      ...
      private com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog result;
      ...
      private static Builder create() {
        ...
        builder.result = new com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog();
        return builder;
      }
      
      protected com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog internalGetResult() {
        return result;
      }
      ...
      public Builder clear() {
        ...
        result = new com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog();
        return this;
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog.getDescriptor();
      }
      
      public com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog getDefaultInstanceForType() {
        return com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog.getDefaultInstance();
      }
      
      public boolean isInitialized() {
        return result.isInitialized();
      }
      public com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog build() {
      ...
      private com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        if (!isInitialized()) {
      ...
      public com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog buildPartial() {
        if (result == null) {
          throw new IllegalStateException(
        ...
        com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog returnMe = result;
        result = null;
        return returnMe;
      }
      
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog) {
          return mergeFrom((com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog)other);
        } else {
      ...
      public Builder mergeFrom(com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog other) {
        if (other == com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog.getDefaultInstance()) return this;
        if (other.hasLogId()) {
        ...
        if (!other.rsltMsg_.isEmpty()) {
          if (result.rsltMsg_.isEmpty()) {
            result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult>();
          }
          result.rsltMsg_.addAll(other.rsltMsg_);
        }
        if (!other.trigInfo_.isEmpty()) {
          if (result.trigInfo_.isEmpty()) {
            result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig>();
          }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 266: {
              com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult.Builder subBuilder = com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addRsltMsg(subBuilder.buildPartial());
              break;
            }
            case 274: {
              com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig.Builder subBuilder = com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
  ...
  result.hasExtInfo = true;
      ...
      public Builder setRsltMsg(int index, com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setRsltMsg(int index, com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult.Builder builderForValue) {
        result.rsltMsg_.set(index, builderForValue.build());
        return this;
      }
      public Builder addRsltMsg(com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.rsltMsg_.isEmpty()) {
      ...
      public Builder addRsltMsg(com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult.Builder builderForValue) {
        if (result.rsltMsg_.isEmpty()) {
          result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult>();
        }
      ...
      public Builder addAllRsltMsg(
          java.lang.Iterable<? extends com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult> values) {
        if (result.rsltMsg_.isEmpty()) {
          result.rsltMsg_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.TriggerResult>();
        }
      ...
      public Builder setTrigInfo(int index, com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      public Builder setTrigInfo(int index, com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig.Builder builderForValue) {
        result.trigInfo_.set(index, builderForValue.build());
        return this;
      }
      public Builder addTrigInfo(com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig value) {
        if (value == null) {
          throw new NullPointerException();
        }
        if (result.trigInfo_.isEmpty()) {
      ...
      public Builder addTrigInfo(com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig.Builder builderForValue) {
        if (result.trigInfo_.isEmpty()) {
          result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig>();
        }
      ...
      public Builder addAllTrigInfo(
          java.lang.Iterable<? extends com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig> values) {
        if (result.trigInfo_.isEmpty()) {
          result.trigInfo_ = new java.util.ArrayList<com.hikvision.cms.api.eps.beds.face.Comm.CommEventTrig>();
        }
    ...
    static {
      ...
      com.hikvision.cms.api.eps.beds.face.EventDis.internalForceInit();
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_com_hikvision_cms_api_eps_beds_CommEventLog_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog.class,
              com.hikvision.cms.api.eps.beds.face.EventDis.CommEventLog.Builder.class);
          return null;
        }
      };
