...
import com.alibaba.cobar.client.router.config.AbstractCobarInternalRouterConfigurationFactoryBean;
...
public class RouterXmlFactoryBean extends AbstractCobarInternalRouterConfigurationFactoryBean {
